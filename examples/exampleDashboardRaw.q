...
/ exampleDashboardRaw.q - Streaming market-data dashboard built directly on
/ .qvis (no inspect.q) - hand-rolled panels, layout and input handling.
/ See examples/exampleDashboard.q for the same idea built on .vis.dash, in
/ about a tenth of the code.
